...
const Footer = () => (
  <div className="flex flex-col md:flex-row gap-9 md:gap-0 md:justify-between items-center absolute bottom-10 left-0 w-full md:px-[100px] pt-10 border-t-black border-t z-50">
