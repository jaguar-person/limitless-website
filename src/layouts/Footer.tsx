...
const Footer = () => (
  <div className="absolute bottom-9 md:bottom-12 left-0 flex flex-col md:flex-row gap-9 md:gap-0 md:justify-between items-center w-full md:px-[100px] pt-9 md:pt-10 border-t border-t-black  z-40">
